...
export function AppShellFrame({ user, studioName, onLogout, children }: { user: V6User; studioName?: string; onLogout: () => void; children: ReactNode }) {
  ...
  return (
    <div suppressHydrationWarning className="min-h-[var(--app-height)] overflow-x-hidden bg-[#040405] text-white" dir="rtl">
      ...
      <div
        className="relative z-10 mx-auto w-full max-w-[430px] px-4 pb-[calc(14rem+env(safe-area-inset-bottom,0px))] pt-[calc(0.8rem+env(safe-area-inset-top,0px))] sm:px-5 md:max-w-5xl"
